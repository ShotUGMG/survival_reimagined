...
public class PigletEntity extends PathfinderMob {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new AvoidEntityGoal<>(this, Player.class, (float) 8, 1, 1.2) {
			...
			public boolean canUse() {
				double x = PigletEntity.this.getX();
				double y = PigletEntity.this.getY();
				double z = PigletEntity.this.getZ();
				Entity entity = PigletEntity.this;
				Level world = PigletEntity.this.level();
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("survival_reimagined:ambient/piglet"));
	}
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("survival_reimagined:hurt/piglet"));
	}
	...
	public void baseTick() {
		super.baseTick();
		PigletFollowMotherProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
