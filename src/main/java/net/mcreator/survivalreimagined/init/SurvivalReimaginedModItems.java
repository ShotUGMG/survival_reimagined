...
import net.mcreator.survivalreimagined.item.GasMaskArmorItem;
...
public class SurvivalReimaginedModItems {
	...
	public static final DeferredItem<Item> GAS_MASK_ARMOR_HELMET = REGISTRY.register("gas_mask_armor_helmet", GasMaskArmorItem.Helmet::new);
