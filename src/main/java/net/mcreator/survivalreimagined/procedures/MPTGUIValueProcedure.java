...
public class MPTGUIValueProcedure {
	public static String execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return "";
		if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof SurvivalReimaginedModMenus.MenuAccessor _menu0 ? _menu0.getSlots().get(2).getItem() : ItemStack.EMPTY).getItem() == SurvivalReimaginedModItems.REACTOR_ROD
				.get()
			...
			return "Reactor Rod Capacity: " + Math.round(getBlockNBTNumber(world, BlockPos.containing(x, y, z), "ReactorRodDepletion"));
		}
		return "\n";
	}
