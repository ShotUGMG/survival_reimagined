...
public class SheepCarcassBlockDestroyedByPlayerProcedure {
		...
		if (new Object() {
			...
			if ((blockstate.getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip2 ? blockstate.getValue(_getip2) : -1) == 0) {
				if (world instanceof ServerLevel _level) {
					ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(SurvivalReimaginedModBlocks.SHEEP_CARCASS.get()));
