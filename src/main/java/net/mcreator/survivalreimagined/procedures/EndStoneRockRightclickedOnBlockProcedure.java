...
public class EndStoneRockRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, ItemStack itemstack) {
		if ((world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == Blocks.AIR) {
			world.setBlock(BlockPos.containing(x, y + 1, z), SurvivalReimaginedModBlocks.END_STONE_ROCK_BLOCK.get().defaultBlockState(), 3);
