...
public class ClayCrucibleOnTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (world instanceof Level _lvl0 && _lvl0.isDay() && !world.getLevelData().isRaining()) {
			if (Math.random() < 0.025) {
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockState _bs = SurvivalReimaginedModBlocks.CRUCIBLE.get().defaultBlockState();
