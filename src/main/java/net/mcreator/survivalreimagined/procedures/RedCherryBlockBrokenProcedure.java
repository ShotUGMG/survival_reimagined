...
@EventBusSubscriber
public class RedCherryBlockBrokenProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (getEntityGameType(entity) == GameType.SURVIVAL || getEntityGameType(entity) == GameType.ADVENTURE) {
			if ((world.getBlockState(BlockPos.containing(x, y, z))) == (blockStateWithInt(SurvivalReimaginedModBlocks.CHERRIES_FRUIT.get().defaultBlockState(), "age", 1))) {
		...
		} else if ((world.getBlockState(BlockPos.containing(x, y, z))) == (blockStateWithInt(SurvivalReimaginedModBlocks.CHERRIES_FRUIT.get().defaultBlockState(), "age", 1))) {
