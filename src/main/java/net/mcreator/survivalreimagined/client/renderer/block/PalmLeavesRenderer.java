...
public class PalmLeavesRenderer implements BlockEntityRenderer<PalmLeavesBlockEntity> {
	...
	PalmLeavesRenderer(BlockEntityRendererProvider.Context context) {
		this.model = new CustomHierarchicalModel(context.bakeLayer(Modelleaves.LAYER_LOCATION));
		this.texture = ResourceLocation.parse("survival_reimagined:textures/block/palm_leaves.png");
	}

	@Override
	public void render(PalmLeavesBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource renderer, int light, int overlayLight) {
		poseStack.pushPose();
	...
	public static void registerBlockEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		event.registerBlockEntityRenderer(SurvivalReimaginedModBlockEntities.PALM_LEAVES.get(), PalmLeavesRenderer::new);
	}

	private static final class CustomHierarchicalModel extends Modelleaves {
		...
		public void setupBlockEntityAnim(PalmLeavesBlockEntity blockEntity, float ageInTicks) {
