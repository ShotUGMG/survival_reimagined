...
public class MetalRefiningTableGUIScreen extends AbstractContainerScreen<MetalRefiningTableGUIMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.survival_reimagined.metal_refining_table_gui.label_metal_refining_table"), 37, 3, -12829636, false);
	}
