...
public class MPTGUIScreen extends AbstractContainerScreen<MPTGUIMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		if (MPTDisplayTickProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("survival_reimagined:textures/screens/arrow.png"), this.leftPos + 79, this.topPos + 34, 0, 0, 16, 16, 16, 16);
		}
		if (MPTDisplayTick1Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("survival_reimagined:textures/screens/arrow2.png"), this.leftPos + 79, this.topPos + 34, 0, 0, 16, 16, 16, 16);
		}
		if (MPTDisplayTick2Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("survival_reimagined:textures/screens/arrow3.png"), this.leftPos + 79, this.topPos + 34, 0, 0, 16, 16, 16, 16);
		}
		if (MPTDisplayTick3Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("survival_reimagined:textures/screens/arrow4.png"), this.leftPos + 79, this.topPos + 34, 0, 0, 16, 16, 16, 16);
		}
		if (MPTDisplayTick4Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("survival_reimagined:textures/screens/arrow5.png"), this.leftPos + 79, this.topPos + 34, 0, 0, 16, 16, 16, 16);
		}
		if (MPTDisplayTick5Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("survival_reimagined:textures/screens/arrow6.png"), this.leftPos + 79, this.topPos + 34, 0, 0, 16, 16, 16, 16);
		}
		if (MPTDisplayTick6Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("survival_reimagined:textures/screens/arrow7.png"), this.leftPos + 79, this.topPos + 34, 0, 0, 16, 16, 16, 16);
		}
		if (MPTDisplayTick7Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("survival_reimagined:textures/screens/arrow8.png"), this.leftPos + 79, this.topPos + 34, 0, 0, 16, 16, 16, 16);
		}
		if (MPTDisplayTick8Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("survival_reimagined:textures/screens/arrow9.png"), this.leftPos + 79, this.topPos + 34, 0, 0, 16, 16, 16, 16);
		}
		if (MPTDisplayTick9Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("survival_reimagined:textures/screens/arrow10.png"), this.leftPos + 79, this.topPos + 34, 0, 0, 16, 16, 16, 16);
		}
		if (MPTDisplayTick10Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("survival_reimagined:textures/screens/arrow11.png"), this.leftPos + 79, this.topPos + 34, 0, 0, 16, 16, 16, 16);
		}
		if (MPTDisplayTick11Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("survival_reimagined:textures/screens/arrow12.png"), this.leftPos + 79, this.topPos + 34, 0, 0, 16, 16, 16, 16);
		}
		if (MPTDisplayTick12Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("survival_reimagined:textures/screens/arrow13.png"), this.leftPos + 79, this.topPos + 34, 0, 0, 16, 16, 16, 16);
		}
		if (MPTDisplayTick13Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("survival_reimagined:textures/screens/arrow14.png"), this.leftPos + 79, this.topPos + 34, 0, 0, 16, 16, 16, 16);
		}
		if (MPTDisplayTick14Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("survival_reimagined:textures/screens/arrow15.png"), this.leftPos + 79, this.topPos + 34, 0, 0, 16, 16, 16, 16);
		}
