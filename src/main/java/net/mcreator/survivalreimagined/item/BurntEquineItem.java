...
public class BurntEquineItem extends Item {
	public BurntEquineItem() {
		super(new Item.Properties().food((new FoodProperties.Builder()).nutrition(7).saturationModifier(11.5f).build()));
	}
