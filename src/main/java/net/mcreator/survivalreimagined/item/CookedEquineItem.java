...
public class CookedEquineItem extends Item {
	public CookedEquineItem() {
		super(new Item.Properties().food((new FoodProperties.Builder()).nutrition(10).saturationModifier(13.4f).build()));
	}
