...
public class CookedMuttonItem extends Item {
	public CookedMuttonItem() {
		super(new Item.Properties().food((new FoodProperties.Builder()).nutrition(4).saturationModifier(6.8f).build()));
	}
