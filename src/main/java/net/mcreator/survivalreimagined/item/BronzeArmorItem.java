...
public abstract class BronzeArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_iron")), () -> Ingredient.of(new ItemStack(SurvivalReimaginedModItems.BRONZE_INGOT.get())),
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("survival_reimagined:bronze"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("survival_reimagined:bronze_armor"), armorMaterial);
