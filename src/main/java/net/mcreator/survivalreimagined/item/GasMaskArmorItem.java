...
public abstract class GasMaskArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(ItemTags.create(ResourceLocation.parse("c:animal/hide"))), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("survival_reimagined:gasmask"))),
					0f, 0f);
			registerHelper.register(ResourceLocation.parse("survival_reimagined:gas_mask_armor"), armorMaterial);
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		...
		}, SurvivalReimaginedModItems.GAS_MASK_ARMOR_HELMET.get());
	}

	public GasMaskArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends GasMaskArmorItem {
		public Helmet() {
