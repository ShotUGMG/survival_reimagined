...
public class CookedChickenItem extends Item {
	public CookedChickenItem() {
		super(new Item.Properties().food((new FoodProperties.Builder()).nutrition(5).saturationModifier(6.8f).build()));
	}
