...
public class BananaGrowBlockBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(9, ItemStack.EMPTY);

	public BananaGrowBlockBlockEntity(BlockPos position, BlockState state) {
