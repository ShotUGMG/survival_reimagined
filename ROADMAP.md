...
Nether
 ...
 - Necroticite Metal, tools, armor. similar to netherite but ingots must be alloy'd (netherite scrap, necroticite fragments), needs netherite to mine
 ...
 Farming
 ~~- Tropical coasts biome, found on coasts~~
 ~~- Strawberries, wild strawberries can be found in savannas, plains, birch forest and normal taiga forest and meadow. Harvested Strawberries can be replanted to grow new strawberries. single plant can drop 3-4 strawberries~~
 ~~- Banana Trees, wild trees can be found in jungles, and bamboo forests and tropical forests. grow on side of tree~~
 ~~- Palm Trees (Coconut Trees) found on tropical coasts~~
 ...
 - cherries grown on small trees found in cherry grove
 - cranberries found on swamp water
